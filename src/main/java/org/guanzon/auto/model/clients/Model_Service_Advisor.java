 ...
 * @author Arsiela
 */
public class Model_Service_Advisor implements GEntity {

    final String XML = "Model_Service_Advisor.xml";
     ...
     */
    public Model_Service_Advisor(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Service_Advisor loOldEntity = new Model_Service_Advisor(poGRider);
