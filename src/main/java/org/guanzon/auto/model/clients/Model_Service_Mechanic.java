 ...
 * @author Arsiela
 */
public class Model_Service_Mechanic implements GEntity {
    final String XML = "Model_Service_Mechanic.xml";
    String psExclude = "sLastName»sFrstName»sMiddName»sCompnyNm»sAddressx»cClientTp";
     ...
     */
    public Model_Service_Mechanic(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Service_Mechanic loOldEntity = new Model_Service_Mechanic(poGRider);
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sClientID = " + SQLUtil.toSQL(this.getClientID()),psExclude);
